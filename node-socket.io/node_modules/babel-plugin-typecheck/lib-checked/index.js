...
exports.default = function (_ref97) {
  var t = _ref97.types;
  var template = _ref97.template;
  ...
  var visitors = {
    ...
    ImportDeclaration: function ImportDeclaration(path) {
      ...
      }).reduce(function (_ref98, _ref99) {
        var _ref101 = _slicedToArray(_ref98, 2);

        var declarators = _ref101[0];
        var specifiers = _ref101[1];

        var _ref100 = _slicedToArray(_ref99, 2);

        var declarator = _ref100[0];
        var specifier = _ref100[1];
    ...
    VariableDeclaration: function VariableDeclaration(path) {
      ...
      for (var i = 0; i < node.declarations.length; i++) {
        ...
        var _id112 = declaration.id;
        var init = declaration.init;

        if (!_id112.typeAnnotation || _id112.hasBeenTypeChecked) {
          continue;
        }
        _id112.savedTypeAnnotation = _id112.typeAnnotation;
        _id112.hasBeenTypeChecked = true;
        var ok = staticCheckAnnotation(declarations[i], _id112.typeAnnotation);
        if (ok === true) {
          continue;
        } else if (ok === false) {
          throw path.buildCodeFrameError('Invalid assignment value, expected ' + humanReadableType(_id112.typeAnnotation) + ' got ' + humanReadableType(getAnnotation(declarations[i])));
        }
        var check = checkAnnotation(_id112, _id112.typeAnnotation, scope);
        if (check) {
          collected.push(guard({
            check: check,
            message: varTypeErrorMessage(_id112, scope)
          }));
        }
      }
  ...
  function createFunctionYieldGuards(path) {
    ...
    if (yieldType) {
      ...
      var _id113 = scope.generateUidIdentifier('id');
      var check = checkAnnotation(_id113, yieldType, scope);
      if (check) {
        node.yieldGuard = guardFn({
          id: _id113,
          name: _name,
          check: check,
          message: yieldTypeErrorMessage(node, yieldType, _id113)
        });
    ...
    if (nextType) {
      ...
      var _id114 = scope.generateUidIdentifier('id');
      var check = checkAnnotation(_id114, nextType, scope);
      if (check) {
        node.nextGuard = guardFn({
          id: _id114,
          name: _name2,
          check: check,
          message: yieldNextTypeErrorMessage(node, nextType, _id114)
        });
  ...
  function createStaticChecks() {
    return {
      ...
      instanceof: function _instanceof(_ref102) {
        var path = _ref102.path;
        var annotation = _ref102.annotation;
  ...
  function checkNullable(_ref104) {
    var input = _ref104.input;
    var type = _ref104.type;
    var scope = _ref104.scope;
  ...
  function checkTypeof(_ref105) {
    var input = _ref105.input;
    var annotation = _ref105.annotation;
    var scope = _ref105.scope;
  ...
  function checkStringLiteral(_ref106) {
    var input = _ref106.input;
    var annotation = _ref106.annotation;
  ...
  function checkNumericLiteral(_ref107) {
  ...
  function checkBooleanLiteral(_ref108) {
  ...
  function checkUnion(_ref109) {
    var input = _ref109.input;
    var types = _ref109.types;
    var scope = _ref109.scope;
  ...
  function checkIntersection(_ref110) {
    var input = _ref110.input;
    var types = _ref110.types;
    var scope = _ref110.scope;
  ...
  function checkGenerator(_ref113) {
  ...
  function checkIterable(_ref114) {
  ...
  function checkArray(_ref115) {
    ...
    function _ref31(_id47) {
      if (!Node(_id47)) {
        throw new TypeError('Function "checkArray" return value violates contract, expected Node got ' + (_id47 === null ? 'null' : (typeof _id47 === 'undefined' ? 'undefined' : _typeof(_id47)) === 'object' && _id47.constructor ? _id47.constructor.name || '[Unknown Object]' : typeof _id47 === 'undefined' ? 'undefined' : _typeof(_id47)));
      }
    ...
    if (!types || types.length === 0) {
      return _ref31(checkIsArray({ input: input }));
      ...
      return _ref31(t.logicalExpression('&&', checkIsArray({ input: input }), t.callExpression(t.memberExpression(input, t.identifier('every')), [t.functionExpression(null, [item], t.blockStatement([t.returnStatement(check)]))])));
    } else {
      // This is a tuple
      ...
      return _ref31(_checks.reduce(function (last, check, index) {
        return t.logicalExpression("&&", last, check);
      }, t.logicalExpression('&&', checkIsArray({ input: input }), checkLength)));
    }
  }

  function checkTuple(_ref116) {
    ...
    function _ref32(_id48) {
      if (!Node(_id48)) {
        throw new TypeError('Function "checkTuple" return value violates contract, expected Node got ' + (_id48 === null ? 'null' : (typeof _id48 === 'undefined' ? 'undefined' : _typeof(_id48)) === 'object' && _id48.constructor ? _id48.constructor.name || '[Unknown Object]' : typeof _id48 === 'undefined' ? 'undefined' : _typeof(_id48)));
      }
    ...
    return _ref32(checks.reduce(function (last, check, index) {
      return t.logicalExpression("&&", last, check);
    }, t.logicalExpression('&&', checkIsArray({ input: input }), checkLength)));
  }

  function checkObject(_ref117) {
    var input = _ref117.input;
    var properties = _ref117.properties;
    var scope = _ref117.scope;

    function _ref33(_id49) {
      if (!Node(_id49)) {
        throw new TypeError('Function "checkObject" return value violates contract, expected Node got ' + (_id49 === null ? 'null' : (typeof _id49 === 'undefined' ? 'undefined' : _typeof(_id49)) === 'object' && _id49.constructor ? _id49.constructor.name || '[Unknown Object]' : typeof _id49 === 'undefined' ? 'undefined' : _typeof(_id49)));
      }
    ...
    if (input.type === 'ObjectPattern') {
      return _ref33(checkObjectPattern({ input: input, properties: properties, scope: scope }));
    }
  ...
  function checkObjectPattern(_ref118) {
    var input = _ref118.input;
    var properties = _ref118.properties;
    var scope = _ref118.scope;

    function _ref34(_id50) {
      if (!(_id50 == null || Node(_id50))) {
        throw new TypeError('Function "checkObjectPattern" return value violates contract, expected ?Node got ' + (_id50 === null ? 'null' : (typeof _id50 === 'undefined' ? 'undefined' : _typeof(_id50)) === 'object' && _id50.constructor ? _id50.constructor.name || '[Unknown Object]' : typeof _id50 === 'undefined' ? 'undefined' : _typeof(_id50)));
      }
    ...
    try {
      for (var _iterator6 = _input$properties[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        ...
        var key = item.key;
        var _id115 = item.value;

        var prop = propNames[key.name];
        if (!prop) {
          continue;
        }
        var check = checkAnnotation(_id115, prop.value, scope);
        if (check) {
          propChecks[key.name] = check;

          if (!(propChecks[key.name] == null || Node(propChecks[key.name]))) {
            throw new TypeError('Value of "propChecks[key.name]" violates contract, expected ?Node got ' + (propChecks[key.name] === null ? 'null' : _typeof(propChecks[key.name]) === 'object' && propChecks[key.name].constructor ? propChecks[key.name].constructor.name || '[Unknown Object]' : _typeof(propChecks[key.name])));
          }
        }
      }
    } catch (err) {
    ...
    return _ref34(Object.keys(propChecks).reduce(function (last, name) {
  ...
  function createTypeAliasChecks(path) {
    function _ref35(_id51) {
      if (!Node(_id51)) {
        throw new TypeError('Function "createTypeAliasChecks" return value violates contract, expected Node got ' + (_id51 === null ? 'null' : (typeof _id51 === 'undefined' ? 'undefined' : _typeof(_id51)) === 'object' && _id51.constructor ? _id51.constructor.name || '[Unknown Object]' : typeof _id51 === 'undefined' ? 'undefined' : _typeof(_id51)));
      }
    ...
    return _ref35(declaration);
  }

  function createInterfaceChecks(path) {
    function _ref36(_id52) {
      if (!Node(_id52)) {
        throw new TypeError('Function "createInterfaceChecks" return value violates contract, expected Node got ' + (_id52 === null ? 'null' : (typeof _id52 === 'undefined' ? 'undefined' : _typeof(_id52)) === 'object' && _id52.constructor ? _id52.constructor.name || '[Unknown Object]' : typeof _id52 === 'undefined' ? 'undefined' : _typeof(_id52)));
      }
  ...
  function checkAnnotation(input, annotation, scope) {
    function _ref37(_id53) {
      if (!(_id53 == null || Node(_id53))) {
        throw new TypeError('Function "checkAnnotation" return value violates contract, expected ?Node got ' + (_id53 === null ? 'null' : (typeof _id53 === 'undefined' ? 'undefined' : _typeof(_id53)) === 'object' && _id53.constructor ? _id53.constructor.name || '[Unknown Object]' : typeof _id53 === 'undefined' ? 'undefined' : _typeof(_id53)));
      }
    ...
    switch (annotation.type) {
      case 'TypeAnnotation':
      case 'FunctionTypeParam':
        return _ref37(checkAnnotation(input, annotation.typeAnnotation, scope));

      case 'TypeofTypeAnnotation':
        return _ref37(checks.typeof({ input: input, annotation: annotation.argument, scope: scope }));

      case 'GenericTypeAnnotation':
        if (annotation.id.name === 'Array') {
          return _ref37(checks.array({ input: input, types: annotation.typeParameters ? annotation.typeParameters.params : [], scope: scope }));
        } else if (annotation.id.name === 'Generator' && !scope.hasBinding('Generator')) {
          return _ref37(checks.generator({ input: input, types: annotation.typeParameters ? annotation.typeParameters.params : [], scope: scope }));
        } else if (annotation.id.name === 'Iterable' && !scope.hasBinding('Iterable')) {
          return _ref37(checks.iterable({ input: input, types: annotation.typeParameters ? annotation.typeParameters.params : [], scope: scope }));
        } else if (annotation.id.name === 'Map' && !scope.hasBinding('Map')) {
          return _ref37(checks.map({ input: input, types: annotation.typeParameters ? annotation.typeParameters.params : [], scope: scope }));
        } else if (annotation.id.name === 'Set' && !scope.hasBinding('Set')) {
          return _ref37(checks.set({ input: input, types: annotation.typeParameters ? annotation.typeParameters.params : [], scope: scope }));
        } else if (annotation.id.name === 'Function') {
          return _ref37(checks.function({ input: input }));
        } else if (annotation.id.name === 'Symbol') {
          return _ref37(checks.symbol({ input: input }));
        } else if (isTypeChecker(annotation.id, scope)) {
          return _ref37(checks.type({ input: input, type: annotation.id }));
        } else if (isPolymorphicType(annotation.id, scope)) {
          return;
        } else {
          return _ref37(checks.instanceof({ input: input, type: createTypeExpression(annotation.id) }));
        }
      case 'TupleTypeAnnotation':
        return _ref37(checks.tuple({ input: input, types: annotation.types, scope: scope }));

      case 'NumberTypeAnnotation':
        return _ref37(checks.number({ input: input }));

      case 'NumericLiteralTypeAnnotation':
        return _ref37(checks.numericLiteral({ input: input, annotation: annotation }));

      case 'BooleanTypeAnnotation':
        return _ref37(checks.boolean({ input: input }));

      case 'BooleanLiteralTypeAnnotation':
        return _ref37(checks.booleanLiteral({ input: input, annotation: annotation }));

      case 'StringTypeAnnotation':
        return _ref37(checks.string({ input: input }));

      case 'StringLiteralTypeAnnotation':
        return _ref37(checks.stringLiteral({ input: input, annotation: annotation }));

      case 'UnionTypeAnnotation':
        return _ref37(checks.union({ input: input, types: annotation.types, scope: scope }));

      case 'IntersectionTypeAnnotation':
        return _ref37(checks.intersection({ input: input, types: annotation.types, scope: scope }));

      case 'ObjectTypeAnnotation':
        return _ref37(checks.object({ input: input, properties: annotation.properties || [], indexers: annotation.indexers, scope: scope }));

      case 'ArrayTypeAnnotation':
        return _ref37(checks.array({ input: input, types: [annotation.elementType || t.anyTypeAnnotation()], scope: scope }));

      case 'FunctionTypeAnnotation':
        return _ref37(checks.function({ input: input, params: annotation.params, returnType: annotation.returnType }));

      case 'MixedTypeAnnotation':
        return _ref37(checks.mixed({ input: input }));

      case 'AnyTypeAnnotation':
      case 'ExistentialTypeParam':
        return _ref37(checks.any({ input: input }));

      case 'NullableTypeAnnotation':
        return _ref37(checks.nullable({ input: input, type: annotation.typeAnnotation, scope: scope }));

      case 'VoidTypeAnnotation':
        return _ref37(checks.void({ input: input }));
  ...
  function staticCheckAnnotation(path, annotation) {
    function _ref38(_id54) {
      if (!(_id54 == null || typeof _id54 === 'boolean')) {
        throw new TypeError('Function "staticCheckAnnotation" return value violates contract, expected ?bool got ' + (_id54 === null ? 'null' : (typeof _id54 === 'undefined' ? 'undefined' : _typeof(_id54)) === 'object' && _id54.constructor ? _id54.constructor.name || '[Unknown Object]' : typeof _id54 === 'undefined' ? 'undefined' : _typeof(_id54)));
      }
    ...
    switch (annotation.type) {
      case 'TypeAnnotation':
      case 'FunctionTypeParam':
        return _ref38(staticCheckAnnotation(path, annotation.typeAnnotation));

      case 'GenericTypeAnnotation':
        if (isTypeChecker(annotation.id, path.scope)) {
          return _ref38(staticChecks.type({ path: path, type: annotation.id }));
        } else if (isPolymorphicType(annotation.id, path.scope)) {
          return;
        } else if (annotation.id.name === 'Symbol') {
          return _ref38(staticChecks.symbol(path));
        } else {
          return _ref38(staticChecks.instanceof({ path: path, annotation: annotation }));
        }
    }
    return _ref38(compareAnnotations(annotation, other));
  }
  ...
  function getAnnotation(path) {
    function _ref39(_id55) {
      if (!TypeAnnotation(_id55)) {
        throw new TypeError('Function "getAnnotation" return value violates contract, expected TypeAnnotation got ' + (_id55 === null ? 'null' : (typeof _id55 === 'undefined' ? 'undefined' : _typeof(_id55)) === 'object' && _id55.constructor ? _id55.constructor.name || '[Unknown Object]' : typeof _id55 === 'undefined' ? 'undefined' : _typeof(_id55)));
      }
    ...
    return _ref39(annotation || t.anyTypeAnnotation());
  }

  function getAnnotationShallow(path) {
    function _ref40(_id56) {
      if (!(_id56 == null || TypeAnnotation(_id56))) {
        throw new TypeError('Function "getAnnotationShallow" return value violates contract, expected ?TypeAnnotation got ' + (_id56 === null ? 'null' : (typeof _id56 === 'undefined' ? 'undefined' : _typeof(_id56)) === 'object' && _id56.constructor ? _id56.constructor.name || '[Unknown Object]' : typeof _id56 === 'undefined' ? 'undefined' : _typeof(_id56)));
      }
    ...
    if (!path || !path.node) {
      return _ref40(t.voidTypeAnnotation());
    }
    var node = path.node;
    var scope = path.scope;

    if (node.type === 'TypeAlias') {
      return _ref40(node.right);
    } else if (node.type === 'ClassProperty' && node.typeAnnotation) {
      return _ref40(getClassPropertyAnnotation(path));
    } else if (node.type === 'ClassMethod' && node.returnType) {
      return _ref40(getClassMethodAnnotation(path));
    } else if (node.type === 'ObjectProperty' && node.typeAnnotation) {
      return _ref40(getObjectPropertyAnnotation(path));
    } else if (node.type === 'ObjectMethod' && node.returnType) {
      return _ref40(getObjectMethodAnnotation(path));
    } else if (!node.typeAnnotation && !node.savedTypeAnnotation && !node.returnType) {
      switch (path.type) {
        case 'Identifier':
          var binding = scope.getBinding(node.name);
          if (!binding || !binding.identifier) {
            return _ref40(path.getTypeAnnotation());
          }
          var id = binding.identifier;
          if (binding.path.type === 'ObjectPattern') {
            return _ref40(getObjectPatternAnnotation(binding.path, node.name));
          }
          if (id.savedTypeAnnotation) {
            return _ref40(id.savedTypeAnnotation);
          } else if (id.returnType) {
            return _ref40(id.returnType);
          } else if (id.typeAnnotation) {
            return _ref40(id.typeAnnotation);
          } else if (isPolymorphicType(id, scope)) {
            return _ref40(t.anyTypeAnnotation());
          }
          return _ref40(binding.constant ? binding.path.getTypeAnnotation() : path.getTypeAnnotation());

        case 'StringLiteral':
        case 'NumericLiteral':
        case 'BooleanLiteral':
          return _ref40(createLiteralTypeAnnotation(path));

        case 'CallExpression':
          var callee = path.get('callee');
          if (callee.type === 'Identifier') {
            if (callee.name === 'Symbol') {
              return _ref40(t.genericTypeAnnotation('Symbol'));
            }
          ...
          break;
        case 'ThisExpression':
          return _ref40(getThisExpressionAnnotation(path));

        case 'AssignmentExpression':
          return _ref40(getAssignmentExpressionAnnotation(path));
        ...
        case 'ClassDeclaration':
          return _ref40(getClassDeclarationAnnotation(path));
    ...
    return _ref40(node.savedTypeAnnotation || node.returnType || node.typeAnnotation || path.getTypeAnnotation());
  }

  function createLiteralTypeAnnotation(path) {
    function _ref41(_id57) {
      if (!(_id57 == null || TypeAnnotation(_id57))) {
        throw new TypeError('Function "createLiteralTypeAnnotation" return value violates contract, expected ?TypeAnnotation got ' + (_id57 === null ? 'null' : (typeof _id57 === 'undefined' ? 'undefined' : _typeof(_id57)) === 'object' && _id57.constructor ? _id57.constructor.name || '[Unknown Object]' : typeof _id57 === 'undefined' ? 'undefined' : _typeof(_id57)));
      }
    ...
    return _ref41(annotation);
  }

  function getObjectPatternAnnotation(path, name) {
    function _ref42(_id58) {
      if (!(_id58 == null || TypeAnnotation(_id58))) {
        throw new TypeError('Function "getObjectPatternAnnotation" return value violates contract, expected ?TypeAnnotation got ' + (_id58 === null ? 'null' : (typeof _id58 === 'undefined' ? 'undefined' : _typeof(_id58)) === 'object' && _id58.constructor ? _id58.constructor.name || '[Unknown Object]' : typeof _id58 === 'undefined' ? 'undefined' : _typeof(_id58)));
      }
    ...
    if (found.type === 'Identifier') {
      ...
      return _ref42(annotation.value);
    }
  }

  function keyByName(node, name) {
    function _ref43(_id59) {
      if (!(_id59 == null || Node(_id59))) {
        throw new TypeError('Function "keyByName" return value violates contract, expected ?Node got ' + (_id59 === null ? 'null' : (typeof _id59 === 'undefined' ? 'undefined' : _typeof(_id59)) === 'object' && _id59.constructor ? _id59.constructor.name || '[Unknown Object]' : typeof _id59 === 'undefined' ? 'undefined' : _typeof(_id59)));
      }
  ...
  function valueByName(node, name) {
    function _ref44(_id60) {
      if (!(_id60 == null || Node(_id60))) {
        throw new TypeError('Function "valueByName" return value violates contract, expected ?Node got ' + (_id60 === null ? 'null' : (typeof _id60 === 'undefined' ? 'undefined' : _typeof(_id60)) === 'object' && _id60.constructor ? _id60.constructor.name || '[Unknown Object]' : typeof _id60 === 'undefined' ? 'undefined' : _typeof(_id60)));
      }
  ...
  function getObjectPropertyAnnotation(path) {
    function _ref45(_id61) {
      if (!(_id61 == null || TypeAnnotation(_id61))) {
        throw new TypeError('Function "getObjectPropertyAnnotation" return value violates contract, expected ?TypeAnnotation got ' + (_id61 === null ? 'null' : (typeof _id61 === 'undefined' ? 'undefined' : _typeof(_id61)) === 'object' && _id61.constructor ? _id61.constructor.name || '[Unknown Object]' : typeof _id61 === 'undefined' ? 'undefined' : _typeof(_id61)));
      }
    ...
    return _ref45(t.objectTypeProperty(node.key, annotation || t.anyTypeAnnotation()));
  }

  function getObjectMethodAnnotation(path) {
    function _ref46(_id62) {
      if (!(_id62 == null || TypeAnnotation(_id62))) {
        throw new TypeError('Function "getObjectMethodAnnotation" return value violates contract, expected ?TypeAnnotation got ' + (_id62 === null ? 'null' : (typeof _id62 === 'undefined' ? 'undefined' : _typeof(_id62)) === 'object' && _id62.constructor ? _id62.constructor.name || '[Unknown Object]' : typeof _id62 === 'undefined' ? 'undefined' : _typeof(_id62)));
      }
    ...
    var node = path.node;
    return _ref46(t.objectTypeProperty(t.identifier(node.key.name), t.functionTypeAnnotation(null, node.params.map(function (param) {
  ...
  function getThisExpressionAnnotation(path) {
    function _ref47(_id63) {
      if (!(_id63 == null || TypeAnnotation(_id63))) {
        throw new TypeError('Function "getThisExpressionAnnotation" return value violates contract, expected ?TypeAnnotation got ' + (_id63 === null ? 'null' : (typeof _id63 === 'undefined' ? 'undefined' : _typeof(_id63)) === 'object' && _id63.constructor ? _id63.constructor.name || '[Unknown Object]' : typeof _id63 === 'undefined' ? 'undefined' : _typeof(_id63)));
      }
    ...
    return _ref47(t.objectTypeAnnotation([]));
  }

  function getClassDeclarationAnnotation(path) {
    function _ref48(_id64) {
      if (!(_id64 == null || TypeAnnotation(_id64))) {
        throw new TypeError('Function "getClassDeclarationAnnotation" return value violates contract, expected ?TypeAnnotation got ' + (_id64 === null ? 'null' : (typeof _id64 === 'undefined' ? 'undefined' : _typeof(_id64)) === 'object' && _id64.constructor ? _id64.constructor.name || '[Unknown Object]' : typeof _id64 === 'undefined' ? 'undefined' : _typeof(_id64)));
      }
    ...
    return _ref48(t.objectTypeAnnotation(body));
  }
  ...
  function getClassPropertyAnnotation(path) {
    function _ref50(_id66) {
      if (!(_id66 == null || TypeAnnotation(_id66))) {
        throw new TypeError('Function "getClassPropertyAnnotation" return value violates contract, expected ?TypeAnnotation got ' + (_id66 === null ? 'null' : (typeof _id66 === 'undefined' ? 'undefined' : _typeof(_id66)) === 'object' && _id66.constructor ? _id66.constructor.name || '[Unknown Object]' : typeof _id66 === 'undefined' ? 'undefined' : _typeof(_id66)));
      }
    ...
    return _ref50(t.objectTypeProperty(node.key, annotation || t.anyTypeAnnotation()));
  }

  function getClassMethodAnnotation(path) {
    function _ref51(_id67) {
      if (!(_id67 == null || TypeAnnotation(_id67))) {
        throw new TypeError('Function "getClassMethodAnnotation" return value violates contract, expected ?TypeAnnotation got ' + (_id67 === null ? 'null' : (typeof _id67 === 'undefined' ? 'undefined' : _typeof(_id67)) === 'object' && _id67.constructor ? _id67.constructor.name || '[Unknown Object]' : typeof _id67 === 'undefined' ? 'undefined' : _typeof(_id67)));
      }
    ...
    if (node.kind === 'get') {
      return _ref51(t.objectTypeProperty(node.key, node.savedTypeAnnotation || node.returnType || node.typeAnnotation || t.anyTypeAnnotation()));
    } else if (node.kind === 'set') {
      return _ref51(t.objectTypeProperty(node.key, node.params.map(function (param) {
        return param.savedTypeAnnotation || param.typeAnnotation;
      }).shift() || t.anyTypeAnnotation()));
    } else {
      return _ref51(t.objectTypeProperty(node.key, t.functionTypeAnnotation(null, node.params.map(function (param) {
  ...
  function getBinaryExpressionAnnotation(path) {
    function _ref52(_id68) {
      if (!TypeAnnotation(_id68)) {
        throw new TypeError('Function "getBinaryExpressionAnnotation" return value violates contract, expected TypeAnnotation got ' + (_id68 === null ? 'null' : (typeof _id68 === 'undefined' ? 'undefined' : _typeof(_id68)) === 'object' && _id68.constructor ? _id68.constructor.name || '[Unknown Object]' : typeof _id68 === 'undefined' ? 'undefined' : _typeof(_id68)));
      }
    ...
    if (isBooleanExpression(node)) {
      return _ref52(t.booleanTypeAnnotation());
    } else {
      return _ref52(t.anyTypeAnnotation());
    }
  }

  function getLogicalExpressionAnnotation(path) {
    function _ref53(_id69) {
      if (!TypeAnnotation(_id69)) {
        throw new TypeError('Function "getLogicalExpressionAnnotation" return value violates contract, expected TypeAnnotation got ' + (_id69 === null ? 'null' : (typeof _id69 === 'undefined' ? 'undefined' : _typeof(_id69)) === 'object' && _id69.constructor ? _id69.constructor.name || '[Unknown Object]' : typeof _id69 === 'undefined' ? 'undefined' : _typeof(_id69)));
      }
    ...
    if (isBooleanExpression(node)) {
      return _ref53(t.booleanTypeAnnotation());
    } else {
      var left = path.get('left');
      var right = path.get('right');
      switch (node.operator) {
        case '&&':
        case '||':
          var _ref119 = [getAnnotation(left), getAnnotation(right)];
          left = _ref119[0];
          right = _ref119[1];

          if (t.isUnionTypeAnnotation(left)) {
            if (t.isUnionTypeAnnotation(right)) {
              return _ref53(t.unionTypeAnnotation(left.types.concat(right.types)));
            } else {
              return _ref53(t.unionTypeAnnotation(left.types.concat(right)));
            }
          } else {
            return _ref53(t.unionTypeAnnotation([left, right]));
          }
      }
      return _ref53(t.anyTypeAnnotation());
    }
  }
  ...
  function getConditionalExpressionAnnotation(path) {
    function _ref54(_id70) {
      if (!TypeAnnotation(_id70)) {
        throw new TypeError('Function "getConditionalExpressionAnnotation" return value violates contract, expected TypeAnnotation got ' + (_id70 === null ? 'null' : (typeof _id70 === 'undefined' ? 'undefined' : _typeof(_id70)) === 'object' && _id70.constructor ? _id70.constructor.name || '[Unknown Object]' : typeof _id70 === 'undefined' ? 'undefined' : _typeof(_id70)));
      }
    ...
    if (t.isUnionTypeAnnotation(consequent)) {
      if (t.isUnionTypeAnnotation(alternate)) {
        return _ref54(t.unionTypeAnnotation(consequent.types.concat(alternate.types)));
      } else {
        return _ref54(t.unionTypeAnnotation(consequent.types.concat(alternate)));
      }
    } else {
      return _ref54(t.unionTypeAnnotation([consequent, alternate]));
    }
  }
  ...
  function getArrayExpressionAnnotation(path) {
    function _ref55(_id71) {
      if (!TypeAnnotation(_id71)) {
        throw new TypeError('Function "getArrayExpressionAnnotation" return value violates contract, expected TypeAnnotation got ' + (_id71 === null ? 'null' : (typeof _id71 === 'undefined' ? 'undefined' : _typeof(_id71)) === 'object' && _id71.constructor ? _id71.constructor.name || '[Unknown Object]' : typeof _id71 === 'undefined' ? 'undefined' : _typeof(_id71)));
      }
    ...
    return _ref55(t.genericTypeAnnotation(t.identifier('Array'), t.typeParameterDeclaration(path.get('elements').map(getAnnotation))));
  }

  function getObjectExpressionAnnotation(path) {
    function _ref56(_id72) {
      if (!TypeAnnotation(_id72)) {
        throw new TypeError('Function "getObjectExpressionAnnotation" return value violates contract, expected TypeAnnotation got ' + (_id72 === null ? 'null' : (typeof _id72 === 'undefined' ? 'undefined' : _typeof(_id72)) === 'object' && _id72.constructor ? _id72.constructor.name || '[Unknown Object]' : typeof _id72 === 'undefined' ? 'undefined' : _typeof(_id72)));
      }
    ...
    return _ref56(annotation);
  }

  function getMemberExpressionAnnotation(path) {
    function _ref57(_id73) {
      if (!TypeAnnotation(_id73)) {
        throw new TypeError('Function "getMemberExpressionAnnotation" return value violates contract, expected TypeAnnotation got ' + (_id73 === null ? 'null' : (typeof _id73 === 'undefined' ? 'undefined' : _typeof(_id73)) === 'object' && _id73.constructor ? _id73.constructor.name || '[Unknown Object]' : typeof _id73 === 'undefined' ? 'undefined' : _typeof(_id73)));
      }
    ...
    if (path.node.computed) {
      return _ref57(getComputedMemberExpressionAnnotation(path));
    }
    var stack = [];
    var target = path;
    ...
    var objectAnnotation = stack.reduceRight(function (last, target) {
      ...
      switch (annotation.type) {
        ...
        case 'ObjectTypeAnnotation':
          ...
          _ref58 = annotation.properties || [];

          if (!(_ref58 && typeof _ref58[Symbol.iterator] === 'function')) {
            throw new TypeError('Expected _ref58 to be iterable, got ' + (_ref58 === null ? 'null' : (typeof _ref58 === 'undefined' ? 'undefined' : _typeof(_ref58)) === 'object' && _ref58.constructor ? _ref58.constructor.name || '[Unknown Object]' : typeof _ref58 === 'undefined' ? 'undefined' : _typeof(_ref58)));
          }
          ...
          try {
            for (var _iterator10 = _ref58[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
              var _ref58;
    ...
    return _ref57(objectAnnotation || path.getTypeAnnotation());
  }

  function getComputedMemberExpressionAnnotation(path) {
    function _ref59(_id74) {
      if (!TypeAnnotation(_id74)) {
        throw new TypeError('Function "getComputedMemberExpressionAnnotation" return value violates contract, expected TypeAnnotation got ' + (_id74 === null ? 'null' : (typeof _id74 === 'undefined' ? 'undefined' : _typeof(_id74)) === 'object' && _id74.constructor ? _id74.constructor.name || '[Unknown Object]' : typeof _id74 === 'undefined' ? 'undefined' : _typeof(_id74)));
      }
    ...
    if (!confident) {
      return _ref59(path.getTypeAnnotation());
    }
    switch (objectAnnotation.type) {
      case 'TupleTypeAnnotation':
        if (objectAnnotation.types.length === 0) {
          ...
          return _ref59(objectAnnotation.types[value]);
        } else {
          throw path.buildCodeFrameError('Invalid computed member expression for tuple: ' + humanReadableType(objectAnnotation));
        }
        break;
  ...
  function getFunctionForIdentifier(path) {
    function _ref60(_id75) {
      if (!(typeof _id75 === 'boolean' || Node(_id75))) {
        throw new TypeError('Function "getFunctionForIdentifier" return value violates contract, expected bool | Node got ' + (_id75 === null ? 'null' : (typeof _id75 === 'undefined' ? 'undefined' : _typeof(_id75)) === 'object' && _id75.constructor ? _id75.constructor.name || '[Unknown Object]' : typeof _id75 === 'undefined' ? 'undefined' : _typeof(_id75)));
      }
    ...
    return _ref60(t.isFunction(ref.path.parent) && ref.path.parentPath);
  }
  ...
  function isStrictlyArrayAnnotation(annotation) {
    function _ref61(_id76) {
      if (!(typeof _id76 === 'boolean')) {
        throw new TypeError('Function "isStrictlyArrayAnnotation" return value violates contract, expected bool got ' + (_id76 === null ? 'null' : (typeof _id76 === 'undefined' ? 'undefined' : _typeof(_id76)) === 'object' && _id76.constructor ? _id76.constructor.name || '[Unknown Object]' : typeof _id76 === 'undefined' ? 'undefined' : _typeof(_id76)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'UnionTypeAnnotation':
        return _ref61(annotation.types.every(isStrictlyArrayAnnotation));
  ...
  function compareMaybeUnion(annotation, comparator) {
    function _ref62(_id77) {
      if (!(_id77 == null || typeof _id77 === 'boolean')) {
        throw new TypeError('Function "compareMaybeUnion" return value violates contract, expected ?bool got ' + (_id77 === null ? 'null' : (typeof _id77 === 'undefined' ? 'undefined' : _typeof(_id77)) === 'object' && _id77.constructor ? _id77.constructor.name || '[Unknown Object]' : typeof _id77 === 'undefined' ? 'undefined' : _typeof(_id77)));
      }
  ...
  function maybeNumberAnnotation(annotation) {
    function _ref63(_id78) {
      if (!(_id78 == null || typeof _id78 === 'boolean')) {
        throw new TypeError('Function "maybeNumberAnnotation" return value violates contract, expected ?bool got ' + (_id78 === null ? 'null' : (typeof _id78 === 'undefined' ? 'undefined' : _typeof(_id78)) === 'object' && _id78.constructor ? _id78.constructor.name || '[Unknown Object]' : typeof _id78 === 'undefined' ? 'undefined' : _typeof(_id78)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref63(maybeNumberAnnotation(annotation.typeAnnotation));
      ...
      case 'UnionTypeAnnotation':
        return _ref63(compareMaybeUnion(annotation, maybeNumberAnnotation));
  ...
  function maybeStringAnnotation(annotation) {
    function _ref64(_id79) {
      if (!(_id79 == null || typeof _id79 === 'boolean')) {
        throw new TypeError('Function "maybeStringAnnotation" return value violates contract, expected ?bool got ' + (_id79 === null ? 'null' : (typeof _id79 === 'undefined' ? 'undefined' : _typeof(_id79)) === 'object' && _id79.constructor ? _id79.constructor.name || '[Unknown Object]' : typeof _id79 === 'undefined' ? 'undefined' : _typeof(_id79)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref64(maybeStringAnnotation(annotation.typeAnnotation));
  ...
  function maybeSymbolAnnotation(annotation) {
    function _ref65(_id80) {
      if (!(_id80 == null || typeof _id80 === 'boolean')) {
        throw new TypeError('Function "maybeSymbolAnnotation" return value violates contract, expected ?bool got ' + (_id80 === null ? 'null' : (typeof _id80 === 'undefined' ? 'undefined' : _typeof(_id80)) === 'object' && _id80.constructor ? _id80.constructor.name || '[Unknown Object]' : typeof _id80 === 'undefined' ? 'undefined' : _typeof(_id80)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref65(maybeSymbolAnnotation(annotation.typeAnnotation));
  ...
  function maybeBooleanAnnotation(annotation) {
    function _ref66(_id81) {
      if (!(_id81 == null || typeof _id81 === 'boolean')) {
        throw new TypeError('Function "maybeBooleanAnnotation" return value violates contract, expected ?bool got ' + (_id81 === null ? 'null' : (typeof _id81 === 'undefined' ? 'undefined' : _typeof(_id81)) === 'object' && _id81.constructor ? _id81.constructor.name || '[Unknown Object]' : typeof _id81 === 'undefined' ? 'undefined' : _typeof(_id81)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref66(maybeBooleanAnnotation(annotation.typeAnnotation));
  ...
  function maybeFunctionAnnotation(annotation) {
    function _ref67(_id82) {
      if (!(_id82 == null || typeof _id82 === 'boolean')) {
        throw new TypeError('Function "maybeFunctionAnnotation" return value violates contract, expected ?bool got ' + (_id82 === null ? 'null' : (typeof _id82 === 'undefined' ? 'undefined' : _typeof(_id82)) === 'object' && _id82.constructor ? _id82.constructor.name || '[Unknown Object]' : typeof _id82 === 'undefined' ? 'undefined' : _typeof(_id82)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref67(maybeFunctionAnnotation(annotation.typeAnnotation));
  ...
  function maybeNullableAnnotation(annotation) {
    function _ref68(_id83) {
      if (!(_id83 == null || typeof _id83 === 'boolean')) {
        throw new TypeError('Function "maybeNullableAnnotation" return value violates contract, expected ?bool got ' + (_id83 === null ? 'null' : (typeof _id83 === 'undefined' ? 'undefined' : _typeof(_id83)) === 'object' && _id83.constructor ? _id83.constructor.name || '[Unknown Object]' : typeof _id83 === 'undefined' ? 'undefined' : _typeof(_id83)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'TypeAnnotation':
      case 'FunctionTypeParam':
        return _ref68(maybeNullableAnnotation(annotation.typeAnnotation));
        ...
        switch (annotation.id.name) {
          ...
          case 'Generator':
            if (annotation.typeParameters && annotation.typeParameters.params.length > 1) {
              return _ref68(maybeNullableAnnotation(annotation.typeParameters.params[1]));
            } else {
              return _ref68(null);
            }
          default:
  ...
  function maybeInstanceOfAnnotation(annotation, expected, typeParameters) {
    function _ref69(_id84) {
      if (!(_id84 == null || typeof _id84 === 'boolean')) {
        throw new TypeError('Function "maybeInstanceOfAnnotation" return value violates contract, expected ?bool got ' + (_id84 === null ? 'null' : (typeof _id84 === 'undefined' ? 'undefined' : _typeof(_id84)) === 'object' && _id84.constructor ? _id84.constructor.name || '[Unknown Object]' : typeof _id84 === 'undefined' ? 'undefined' : _typeof(_id84)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref69(maybeInstanceOfAnnotation(annotation.typeAnnotation, expected, typeParameters));
  ...
  function maybeArrayAnnotation(annotation) {
    function _ref70(_id85) {
      if (!(_id85 == null || typeof _id85 === 'boolean')) {
        throw new TypeError('Function "maybeArrayAnnotation" return value violates contract, expected ?bool got ' + (_id85 === null ? 'null' : (typeof _id85 === 'undefined' ? 'undefined' : _typeof(_id85)) === 'object' && _id85.constructor ? _id85.constructor.name || '[Unknown Object]' : typeof _id85 === 'undefined' ? 'undefined' : _typeof(_id85)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref70(maybeArrayAnnotation(annotation.typeAnnotation));
  ...
  function maybeIterableAnnotation(annotation) {
    function _ref71(_id86) {
      if (!(_id86 == null || typeof _id86 === 'boolean')) {
        throw new TypeError('Function "maybeIterableAnnotation" return value violates contract, expected ?bool got ' + (_id86 === null ? 'null' : (typeof _id86 === 'undefined' ? 'undefined' : _typeof(_id86)) === 'object' && _id86.constructor ? _id86.constructor.name || '[Unknown Object]' : typeof _id86 === 'undefined' ? 'undefined' : _typeof(_id86)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref71(maybeIterableAnnotation(annotation.typeAnnotation));
  ...
  function maybeTupleAnnotation(annotation) {
    function _ref72(_id87) {
      if (!(_id87 == null || typeof _id87 === 'boolean')) {
        throw new TypeError('Function "maybeTupleAnnotation" return value violates contract, expected ?bool got ' + (_id87 === null ? 'null' : (typeof _id87 === 'undefined' ? 'undefined' : _typeof(_id87)) === 'object' && _id87.constructor ? _id87.constructor.name || '[Unknown Object]' : typeof _id87 === 'undefined' ? 'undefined' : _typeof(_id87)));
      }
    ...
    switch (annotation.type) {
      ...
      case 'FunctionTypeParam':
      case 'NullableTypeAnnotation':
        return _ref72(maybeTupleAnnotation(annotation.typeAnnotation));
  ...
  function humanReadableType(annotation) {
    function _ref73(_id88) {
      if (!(typeof _id88 === 'string')) {
        throw new TypeError('Function "humanReadableType" return value violates contract, expected string got ' + (_id88 === null ? 'null' : (typeof _id88 === 'undefined' ? 'undefined' : _typeof(_id88)) === 'object' && _id88.constructor ? _id88.constructor.name || '[Unknown Object]' : typeof _id88 === 'undefined' ? 'undefined' : _typeof(_id88)));
      }
    ...
    switch (annotation.type) {
      ...
      default:
        return _ref73((0, _babelGenerator2.default)(annotation).code);
  ...
  function getTypeChecker(id, scope) {
    function _ref74(_id89) {
      if (!(NodePath(_id89) || _id89 === false)) {
        throw new TypeError('Function "getTypeChecker" return value violates contract, expected NodePath | false got ' + (_id89 === null ? 'null' : (typeof _id89 === 'undefined' ? 'undefined' : _typeof(_id89)) === 'object' && _id89.constructor ? _id89.constructor.name || '[Unknown Object]' : typeof _id89 === 'undefined' ? 'undefined' : _typeof(_id89)));
      }
    ...
    if (path == null) {
      ...
      return _ref74(path.get('declarations')[0]);
  ...
  function getPolymorphicType(id, scope) {
    function _ref77(_id92) {
      if (!(_id92 == null || Node(_id92))) {
        throw new TypeError('Function "getPolymorphicType" return value violates contract, expected ?Node got ' + (_id92 === null ? 'null' : (typeof _id92 === 'undefined' ? 'undefined' : _typeof(_id92)) === 'object' && _id92.constructor ? _id92.constructor.name || '[Unknown Object]' : typeof _id92 === 'undefined' ? 'undefined' : _typeof(_id92)));
      }
  ...
  function collectParamChecks(path) {
    function _ref78(_id93) {
      if (!(Array.isArray(_id93) && _id93.every(function (item) {
        return Node(item);
      }))) {
        throw new TypeError('Function "collectParamChecks" return value violates contract, expected Node[] got ' + (_id93 === null ? 'null' : (typeof _id93 === 'undefined' ? 'undefined' : _typeof(_id93)) === 'object' && _id93.constructor ? _id93.constructor.name || '[Unknown Object]' : typeof _id93 === 'undefined' ? 'undefined' : _typeof(_id93)));
      }
    ...
    return _ref78(path.get('params').map(function (param) {
      var node = param.node;
  ...
  function createParamGuard(path) {
    function _ref79(_id94) {
      if (!(_id94 == null || Node(_id94))) {
        throw new TypeError('Function "createParamGuard" return value violates contract, expected ?Node got ' + (_id94 === null ? 'null' : (typeof _id94 === 'undefined' ? 'undefined' : _typeof(_id94)) === 'object' && _id94.constructor ? _id94.constructor.name || '[Unknown Object]' : typeof _id94 === 'undefined' ? 'undefined' : _typeof(_id94)));
      }
  ...
  function createDefaultParamGuard(path) {
    function _ref80(_id95) {
      if (!(_id95 == null || Node(_id95))) {
        throw new TypeError('Function "createDefaultParamGuard" return value violates contract, expected ?Node got ' + (_id95 === null ? 'null' : (typeof _id95 === 'undefined' ? 'undefined' : _typeof(_id95)) === 'object' && _id95.constructor ? _id95.constructor.name || '[Unknown Object]' : typeof _id95 === 'undefined' ? 'undefined' : _typeof(_id95)));
      }
    ...
    return _ref80(createParamGuard(path.get('left')));
  }

  function createRestParamGuard(path) {
    function _ref81(_id96) {
      if (!(_id96 == null || Node(_id96))) {
        throw new TypeError('Function "createRestParamGuard" return value violates contract, expected ?Node got ' + (_id96 === null ? 'null' : (typeof _id96 === 'undefined' ? 'undefined' : _typeof(_id96)) === 'object' && _id96.constructor ? _id96.constructor.name || '[Unknown Object]' : typeof _id96 === 'undefined' ? 'undefined' : _typeof(_id96)));
      }
  ...
  function returnTypeErrorMessage(path, fn, id) {
    function _ref82(_id97) {
      if (!Node(_id97)) {
        throw new TypeError('Function "returnTypeErrorMessage" return value violates contract, expected Node got ' + (_id97 === null ? 'null' : (typeof _id97 === 'undefined' ? 'undefined' : _typeof(_id97)) === 'object' && _id97.constructor ? _id97.constructor.name || '[Unknown Object]' : typeof _id97 === 'undefined' ? 'undefined' : _typeof(_id97)));
      }
    ...
    return _ref82(t.binaryExpression('+', t.stringLiteral(message), id ? readableName({ input: id }) : node.argument ? readableName({ input: node.argument }) : t.stringLiteral('undefined')));
  }

  function yieldTypeErrorMessage(fn, annotation, id) {
    function _ref83(_id98) {
      if (!Node(_id98)) {
        throw new TypeError('Function "yieldTypeErrorMessage" return value violates contract, expected Node got ' + (_id98 === null ? 'null' : (typeof _id98 === 'undefined' ? 'undefined' : _typeof(_id98)) === 'object' && _id98.constructor ? _id98.constructor.name || '[Unknown Object]' : typeof _id98 === 'undefined' ? 'undefined' : _typeof(_id98)));
      }
    ...
    return _ref83(t.binaryExpression('+', t.stringLiteral(message), readableName({ input: id })));
  }
  function yieldNextTypeErrorMessage(fn, annotation, id) {
    function _ref84(_id99) {
      if (!Node(_id99)) {
        throw new TypeError('Function "yieldNextTypeErrorMessage" return value violates contract, expected Node got ' + (_id99 === null ? 'null' : (typeof _id99 === 'undefined' ? 'undefined' : _typeof(_id99)) === 'object' && _id99.constructor ? _id99.constructor.name || '[Unknown Object]' : typeof _id99 === 'undefined' ? 'undefined' : _typeof(_id99)));
      }
    ...
    return _ref84(t.binaryExpression('+', t.stringLiteral(message), readableName({ input: id })));
  }
  ...
  function paramTypeErrorMessage(node, scope) {
    ...
    function _ref85(_id100) {
      if (!Node(_id100)) {
        throw new TypeError('Function "paramTypeErrorMessage" return value violates contract, expected Node got ' + (_id100 === null ? 'null' : (typeof _id100 === 'undefined' ? 'undefined' : _typeof(_id100)) === 'object' && _id100.constructor ? _id100.constructor.name || '[Unknown Object]' : typeof _id100 === 'undefined' ? 'undefined' : _typeof(_id100)));
      }
    ...
    return _ref85(t.binaryExpression('+', t.stringLiteral(message), readableName({ input: node })));
  }
  ...
  function varTypeErrorMessage(node, scope) {
    ...
    function _ref86(_id101) {
      if (!Node(_id101)) {
        throw new TypeError('Function "varTypeErrorMessage" return value violates contract, expected Node got ' + (_id101 === null ? 'null' : (typeof _id101 === 'undefined' ? 'undefined' : _typeof(_id101)) === 'object' && _id101.constructor ? _id101.constructor.name || '[Unknown Object]' : typeof _id101 === 'undefined' ? 'undefined' : _typeof(_id101)));
      }
    ...
    if (node.type === 'Identifier') {
      ...
      return _ref86(t.binaryExpression('+', t.stringLiteral(message), readableName({ input: node })));
    } else {
  ...
  function createTypeExpression(node) {
    function _ref87(_id102) {
      if (!(_id102 instanceof Object)) {
        throw new TypeError('Function "createTypeExpression" return value violates contract, expected Object got ' + (_id102 === null ? 'null' : (typeof _id102 === 'undefined' ? 'undefined' : _typeof(_id102)) === 'object' && _id102.constructor ? _id102.constructor.name || '[Unknown Object]' : typeof _id102 === 'undefined' ? 'undefined' : _typeof(_id102)));
      }
    ...
    if (node.type == 'Identifier') {
      ...
      return _ref87(t.memberExpression(createTypeExpression(node.qualification), createTypeExpression(node.id)));
    }
  ...
  function getTypeName(node) {
    function _ref88(_id103) {
      if (!(typeof _id103 === 'string')) {
        throw new TypeError('Function "getTypeName" return value violates contract, expected string got ' + (_id103 === null ? 'null' : (typeof _id103 === 'undefined' ? 'undefined' : _typeof(_id103)) === 'object' && _id103.constructor ? _id103.constructor.name || '[Unknown Object]' : typeof _id103 === 'undefined' ? 'undefined' : _typeof(_id103)));
      }
    ...
    if (node.type == 'Identifier') {
      return _ref88(node.name);
    } else if (node.type == 'QualifiedTypeIdentifier') {
      return _ref88(getTypeName(node.qualification) + '.' + getTypeName(node.id));
    }
  ...
  function allowsAny(annotation) {
    function _ref90(_id105) {
      if (!(typeof _id105 === 'boolean')) {
        throw new TypeError('Function "allowsAny" return value violates contract, expected bool got ' + (_id105 === null ? 'null' : (typeof _id105 === 'undefined' ? 'undefined' : _typeof(_id105)) === 'object' && _id105.constructor ? _id105.constructor.name || '[Unknown Object]' : typeof _id105 === 'undefined' ? 'undefined' : _typeof(_id105)));
      }
    ...
    if (annotation.type === 'TypeAnnotation' || annotation.type === 'NullableTypeAnnotation') {
      ...
      return _ref90(annotation.types.some(allowsAny));
    } else {
      return false;
    }
  }
  ...
  function maybeSkipFile(path) {
    function _ref92(_id107) {
      if (!(typeof _id107 === 'boolean')) {
        throw new TypeError('Function "maybeSkipFile" return value violates contract, expected bool got ' + (_id107 === null ? 'null' : (typeof _id107 === 'undefined' ? 'undefined' : _typeof(_id107)) === 'object' && _id107.constructor ? _id107.constructor.name || '[Unknown Object]' : typeof _id107 === 'undefined' ? 'undefined' : _typeof(_id107)));
      }
    ...
    if (path.node.leadingComments && path.node.leadingComments.length) {
      return _ref92(path.node.leadingComments.some(function (comment) {
  ...
  function getExpression(node) {
    function _ref95(_id110) {
      if (!Node(_id110)) {
        throw new TypeError('Function "getExpression" return value violates contract, expected Node got ' + (_id110 === null ? 'null' : (typeof _id110 === 'undefined' ? 'undefined' : _typeof(_id110)) === 'object' && _id110.constructor ? _id110.constructor.name || '[Unknown Object]' : typeof _id110 === 'undefined' ? 'undefined' : _typeof(_id110)));
      }
    ...
    return _ref95(t.isExpressionStatement(node) ? node.expression : node);
  }

  function expression(input) {
    function _ref96(_id111) {
      if (!(typeof _id111 === 'function')) {
        throw new TypeError('Function "expression" return value violates contract, expected Function got ' + (_id111 === null ? 'null' : (typeof _id111 === 'undefined' ? 'undefined' : _typeof(_id111)) === 'object' && _id111.constructor ? _id111.constructor.name || '[Unknown Object]' : typeof _id111 === 'undefined' ? 'undefined' : _typeof(_id111)));
      }

...
exports.default = function (_ref) {
  ...
  function createFunctionYieldGuards(path) {
    ...
    if (yieldType) {
      ...
      var _id2 = scope.generateUidIdentifier('id');
      var check = checkAnnotation(_id2, yieldType, scope);
      if (check) {
        node.yieldGuard = guardFn({
          id: _id2,
          name: _name,
          check: check,
          message: yieldTypeErrorMessage(node, yieldType, _id2)
        });
    ...
    if (nextType) {
      ...
      var _id3 = scope.generateUidIdentifier('id');
      var check = checkAnnotation(_id3, nextType, scope);
      if (check) {
        node.nextGuard = guardFn({
          id: _id3,
          name: _name2,
          check: check,
          message: yieldNextTypeErrorMessage(node, nextType, _id3)
        });
  ...
  function checkGenerator(_ref17) {
    var input = _ref17.input;
    var types = _ref17.types;
    var scope = _ref17.scope;

    return checkIsGenerator({ input: input });
  }

  function checkIterable(_ref18) {
    var input = _ref18.input;
    var types = _ref18.types;
    var scope = _ref18.scope;

    return checkIsIterable({ input: input });
  }

  function checkArray(_ref19) {
    var input = _ref19.input;
    var types = _ref19.types;
  ...
  function checkTuple(_ref20) {
    var input = _ref20.input;
    var types = _ref20.types;
  ...
  function checkObjectPattern(_ref22) {
    ...
    try {
      for (var _iterator6 = input.properties[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        ...
        var check = checkAnnotation(_id4, prop.value, scope);
        if (check) {
    ...
    return Object.keys(propChecks).reduce(function (last, name) {
    ...
    switch (annotation.type) {
      ...
      case 'GenericTypeAnnotation':
        if (annotation.id.name === 'Array') {
          ...
          return checks.generator({ input: input, types: annotation.typeParameters ? annotation.typeParameters.params : [], scope: scope });
        } else if (annotation.id.name === 'Iterable' && !scope.hasBinding('Iterable')) {
          return checks.iterable({ input: input, types: annotation.typeParameters ? annotation.typeParameters.params : [], scope: scope });
    ...
    switch (annotation.type) {
      ...
      case 'GenericTypeAnnotation':
        if (isTypeChecker(annotation.id, path.scope)) {
          ...
          return staticChecks.instanceof({ path: path, annotation: annotation });
        }
    }
  ...
  function getObjectPatternAnnotation(path, name) {
    ...
    try {
      for (var _iterator7 = path.get('properties')[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
  ...
  function keyByName(node, name) {
    ...
    try {
      for (var _iterator8 = node.properties[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
  ...
  function valueByName(node, name) {
    ...
    try {
      for (var _iterator9 = node.properties[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
  ...
  function getObjectPropertyAnnotation(path) {
    ...
    return t.objectTypeProperty(node.key, annotation || t.anyTypeAnnotation());
  }

  function getObjectMethodAnnotation(path) {
    var node = path.node;

    return t.objectTypeProperty(t.identifier(node.key.name), t.functionTypeAnnotation(null, node.params.map(function (param) {
  ...
  function getClassMethodAnnotation(path) {
    ...
    if (node.kind === 'get') {
      return t.objectTypeProperty(node.key, node.savedTypeAnnotation || node.returnType || node.typeAnnotation || t.anyTypeAnnotation());
    } else if (node.kind === 'set') {
      return t.objectTypeProperty(node.key, node.params.map(function (param) {
        return param.savedTypeAnnotation || param.typeAnnotation;
      }).shift() || t.anyTypeAnnotation());
    } else {
      return t.objectTypeProperty(node.key, t.functionTypeAnnotation(null, node.params.map(function (param) {
  ...
  function getLogicalExpressionAnnotation(path) {
    ...
    if (isBooleanExpression(node)) {
      ...
      switch (node.operator) {
        case '&&':
        case '||':
          var _ref23 = [getAnnotation(left), getAnnotation(right)];
          left = _ref23[0];
          right = _ref23[1];
  ...
  function getArrayExpressionAnnotation(path) {
    return t.genericTypeAnnotation(t.identifier('Array'), t.typeParameterDeclaration(path.get('elements').map(getAnnotation)));
  }
    ...
    var objectAnnotation = stack.reduceRight(function (last, target) {
      ...
      switch (annotation.type) {
        ...
        case 'ObjectTypeAnnotation':
          ...
          try {
            for (var _iterator10 = (annotation.properties || [])[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
  ...
  function maybeNullableAnnotation(annotation) {
    switch (annotation.type) {
      ...
      case 'UnionTypeAnnotation':
        ...
        try {
          for (var _iterator16 = annotation.types[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
            var _type10 = _step16.value;
  ...
  function maybeInstanceOfAnnotation(annotation, expected, typeParameters) {
    switch (annotation.type) {
      ...
      case 'UnionTypeAnnotation':
        ...
        try {
          for (var _iterator17 = annotation.types[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
            var _type11 = _step17.value;

            var result = maybeInstanceOfAnnotation(_type11, expected, typeParameters);
            if (result === true) {
              return true;
            } else if (result === false) {
              falseCount++;
  ...
  function maybeArrayAnnotation(annotation) {
    switch (annotation.type) {
      ...
      case 'UnionTypeAnnotation':
        ...
        try {
          for (var _iterator18 = annotation.types[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
            var _type12 = _step18.value;
  ...
  function maybeIterableAnnotation(annotation) {
    switch (annotation.type) {
      ...
      case 'UnionTypeAnnotation':
        ...
        try {
          for (var _iterator19 = annotation.types[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
            var _type13 = _step19.value;

            var result = maybeIterableAnnotation(_type13);
            if (result === true) {
              return true;
            } else if (result === false) {
              falseCount++;
  ...
  function maybeTupleAnnotation(annotation) {
    switch (annotation.type) {
      ...
      case 'UnionTypeAnnotation':
        ...
        try {
          for (var _iterator20 = annotation.types[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
            var _type14 = _step20.value;

            var result = maybeTupleAnnotation(_type14);
            if (result === true) {
              return true;
            } else if (result === false) {
              falseCount++;
  ...
  function humanReadableType(annotation) {
    switch (annotation.type) {
      ...
      default:
        return (0, _babelGenerator2.default)(annotation).code;
    }
  }
  ...
  function isPolymorphicType(id, scope) {
    ...
    while (path && path.type !== 'Program') {
      ...
      if ((t.isFunction(_node) || t.isClass(_node)) && _node.typeParameters) {
        ...
        try {
          for (var _iterator21 = _node.typeParameters.params[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
  ...
  function getPolymorphicType(id, scope) {
    ...
    while (path && path.type !== 'Program') {
      ...
      if (t.isFunction(_node2) && _node2.typeParameters) {
        ...
        try {
          for (var _iterator22 = _node2.typeParameters.params[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
  ...
  function collectParamChecks(path) {
    return path.get('params').map(function (param) {
      var node = param.node;
  ...
  function returnTypeErrorMessage(path, fn, id) {
    ...
    return t.binaryExpression('+', t.stringLiteral(message), id ? readableName({ input: id }) : node.argument ? readableName({ input: node.argument }) : t.stringLiteral('undefined'));
  }
  ...
  function yieldTypeErrorMessage(fn, annotation, id) {
    ...
    return t.binaryExpression('+', t.stringLiteral(message), readableName({ input: id }));
  }
  ...
  function paramTypeErrorMessage(node, scope) {
    ...
    return t.binaryExpression('+', t.stringLiteral(message), readableName({ input: node }));
  }
  ...
  function maybeSkipFile(path) {
    if (path.node.leadingComments && path.node.leadingComments.length) {
      return path.node.leadingComments.some(function (comment) {
